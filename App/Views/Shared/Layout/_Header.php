...
<div class="navbar-header">
    ...
    <div class="d-flex">
        ...
        <div class="dropdown d-inline-block">
            <button onclick="window.location.href='/setting'" type="button" class="btn header-item right-bar-toggle me-2">
        ...
        <div class="dropdown d-inline-block">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <!-- item-->
                <a class="dropdown-item" href="/user/profile"><i class="mdi mdi mdi-face-man font-size-16 align-middle me-1"></i> Profile</a>
